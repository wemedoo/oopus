...
namespace sReportsV2.Api.Controllers
{
    ...
    public class CapabilityStatementController //: CommonController
    {
     ...
     : base(mapper, formInstanceService, episodeOfCareService, encounterService, formService) { }
        ...
        {
            capabilityStatement.Name = ResourceTypes.ApplicationName;
            ...
            capabilityStatement.Contact = new List<ContactDetail>() { new ContactDetail() { Telecom = new List<ContactPoint>() { new ContactPoint() { System = ContactPoint.ContactPointSystem.Url, Value = "https://wemedoo.com/contact-us/" } } } };
            capabilityStatement.Kind = CapabilityStatement.CapabilityStatementKind.Capability;
            capabilityStatement.Software = new CapabilityStatement.SoftwareComponent() { Name = ResourceTypes.ApplicationName };
