namespace sReportsV2.Domain.Sql.Migrations
{
    ...
    public partial class AddTempCountryTable : DbMigration
    {
        ...
        {
            SReportsContext context = new SReportsContext();
            context.Database.ExecuteSqlCommand("drop table dbo.CountryAddressesTempTable");
            context.Database.ExecuteSqlCommand("drop table dbo.CountryPatientAddressesTempTable");
        }
    }
}
