namespace sReportsV2.Domain.Sql.Migrations
{
    ...
    public partial class UpdateViewsToDateTimeOffset : DbMigration
    {
        public override void Up()
        {
			using (var context = new SReportsContext())
			{
				string updatePersonnelViewForRoleAndOrgSort = $@"
            ...
            ";
				...
				string codeAliasViews = @"CREATE OR ALTER VIEW dbo.CodeAliasViews
                                AS 
                                SELECT
            ...
            ";
				...
				context.Database.ExecuteSqlCommand(updatePersonnelViewForRoleAndOrgSort);
				context.Database.ExecuteSqlCommand(codeAliasViews);
			}
		}
